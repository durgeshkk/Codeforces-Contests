...
void solve()
{
    ...
    ll q;cin>>q;
    string s;cin>>s;
    vector<ll> plus_even(n+1,0);
    vector<ll> plus_odd(n+1,0);
    vector<ll> subs_e(n+1,0);
    vector<ll> subs_o(n+1,0);
    ...
    for(ll i=0;i<q;i++){
        ...
        p_e = plus_even[r] - plus_even[l-1];
        p_o = plus_odd[r] - plus_odd[l-1];
        s_e = subs_e[r] - subs_e[l-1];
        s_o = subs_o[r] - subs_o[l-1];
